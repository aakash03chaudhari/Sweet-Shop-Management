...
//	}
	...
	// @Mock : because on SweetItemServiceDaoImpl have dependency to SweetItemRepository,
		...
		{
			SweetItem sweetItem1 = new SweetItem(1,"Jalebi",(float)120,true,new Date(01/01/2020),false);
			when(sweetItemDaoImpl.removeSweetItem(1)).thenReturn(sweetItem1);
			SweetItem expected = sweetItemServiceImpl.removeSweetItem(1);
			assertThat(expected).isNotNull();
		}
		...
		{
			SweetItem sweetItem1 = new SweetItem(1,"Jalebi",(float)120,true,new Date(01/01/2020),false);
			when(sweetItemDaoImpl.modifySweetItem(1, sweetItem1)).thenReturn(sweetItem1);
			SweetItem expected = sweetItemServiceImpl.modifySweetItem(1, sweetItem1);
			assertThat(expected).isNotNull();
		}
}
